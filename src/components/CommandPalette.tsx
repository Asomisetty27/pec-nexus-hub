...
const staticPages = [
  ...
  { label: "Training", path: "/app/training", icon: GraduationCap, group: "Navigate" },
  { label: "Members", path: "/app/members", icon: Users, group: "Navigate" },
  { label: "Command Center", path: "/app/command", icon: Target, group: "Navigate" },
  ...
  { label: "Identity / Permissions", path: "/app/admin?tab=identity", icon: Shield, group: "Navigate" },
  { label: "Analytics", path: "/app/admin?tab=analytics", icon: BarChart3, group: "Navigate" },
  { label: "Invites", path: "/app/admin?tab=invites", icon: Shield, group: "Navigate" },
